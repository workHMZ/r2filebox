/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=scripts/typegen.env.example --env-interface=CloudflareBindings worker/worker-configuration.d.ts` (hash: c8bae76e5e5ebe78b934126010e77610)
