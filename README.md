...
The first run creates or explicitly reuses R2 and D1, generates the admin password hash and required secrets, applies D1 migrations, and deploys the Worker. Existing bindings do not trigger automatic secret rotation.
